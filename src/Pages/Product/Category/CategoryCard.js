    ...
    <div data-aos="zoom-in-up">
     <div className="group relative  duration-500 ease-in-out overflow-hidden" >
             <div className='grid  '>
                  ...
                  <div className="absolute inset-0 md:w-80 bg-[#020b0d8e]  opacity-0 group-hover:opacity-100 duration-500 ease-in-out"></div>
                   
                    <div className="absolute pl-6 flex justify-center ltr:left-50 rtl:right-50 bottom-[100px] opacity-0 group-hover:opacity-100 duration-500 ease-in-out">
                                <div className=" ">
