  ...
  return (
    <div className='lg:pb-44 lg:pt-24 min-h-screen' style={{backgroundImage:(`url(${dot})`)}} >
      ...
      <div className='relative m-auto pb-5 px-5' >
       ...
       <h2 className="font-bold text-6xl text-start   md:text-[120px] text-gray-300 opacity-[0.07] numbs uppercase lg:hidden block"> TEAM</h2>
        <h2 data-aos="zoom-in-right" className='uppercase relative bottom-[70px]  font-extrabold mb-5 text-transparent lg:text-4xl md:text-3xl font-serif  lg:leading-relaxed tracking-wider lg:tracking-[2px] bg-clip-text bg-gradient-to-r from-[#b18551] to-[#000]'>About Our creative Team Spirit.</h2>
       </div>
