  ...
  return (
    <div className='bg-white  relative' style={{backgroundImage:(`url(${bg})`)}}>
       ...
       <h2 className="font-bold text-6xl text-start relative top-[70px]  md:text-[120px] text-gray-300 opacity-[0.1] px-3 numbs">COLLECTION</h2>
        <h2 data-aos="zoom-in-right" className='uppercase text-center   font-extrabold mb-5 text-transparent lg:text-4xl md:text-3xl font-serif  lg:leading-relaxed tracking-wider lg:tracking-[2px] bg-clip-text bg-gradient-to-r from-[#b18551] to-[#000]'>CHECK XANTHOUS Huge Collections Here.</h2>
